...
export const authorsList: Array<Author> = [
  { name: "Gayle Laakmann McDowell", id: 0 },
  { name: "Alfred Aho", id: 1 },
  { name: "Jeffrey Ullman", id: 2 },
  { name: "Ravi Sethi", id: 3 },
  { name: "Monica Lam", id: 4 },
  { name: "Harold Abelson", id: 5 },
  { name: "Thomas H. Cormen", id: 6 },
];
